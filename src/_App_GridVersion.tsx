/**
 * This is a grid version of the app. It mimics the D3.js homepage with hexagon style grids that pop-up on hover.
 * It's not used for anything yet but could be useful for something in the future.
 */
